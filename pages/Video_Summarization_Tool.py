...
def recurisive_summarization(text):
    ...
    chain = load_summarize_chain(OpenAIChat(temperature=0.7, max_tokens = 800), chain_type="refine", return_intermediate_steps=True, question_prompt=PROMPT, refine_prompt=refine_prompt)
