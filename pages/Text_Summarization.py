...
add_page_title("Summarization Input Selection")
...
# selection = str(st.selectbox("What do you want to do: ", ["None", "Summarize Text"]))
st.session_state["task_type"] = "Summarize Text"#selection
...
if input_type != "None":
    nav_page("Summarization_Play_Ground")
